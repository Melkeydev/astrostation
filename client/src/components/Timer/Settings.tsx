...
export const TimerSettings = ({ onClose }) => {
  ...
  return (
    <div className="p-2 space-y-2 py-2 px-1 w-72 sm:w-96 max-w-sm bg-white text-gray-800 rounded-lg shadow-md dark:text-gray-300 dark:bg-gray-800 dark:border-gray-700">
